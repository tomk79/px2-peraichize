 ...
 * px2-peraichize
 */
namespace tomk79\pickles2\peraichize\cce;
...
class main{
    ...
    public function get_client_resource_list(){
        $rtn = array();
        $rtn['css'] = array();
        array_push($rtn['css'], 'peraichizeCceFront.css');
        $rtn['js'] = array();
        array_push($rtn['js'], 'peraichizeCceFront.js');
        return $rtn;
    }
    ...
    public function get_client_initialize_function(){
        return 'window.peraichizeCceFront';
    }
